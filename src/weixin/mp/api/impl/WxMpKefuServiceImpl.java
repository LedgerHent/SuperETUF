...
import weixin.common.util.http.MediaUploadRequestExecutor;
import weixin.mp.api.WxMpKefuService;
import weixin.mp.api.WxMpService;
import weixin.mp.bean.kefu.request.WxMpKfAccountRequest;
import weixin.mp.bean.kefu.request.WxMpKfSessionRequest;
import weixin.mp.bean.kefu.result.WxMpKfList;
import weixin.mp.bean.kefu.result.WxMpKfMsgList;
import weixin.mp.bean.kefu.result.WxMpKfOnlineList;
import weixin.mp.bean.kefu.result.WxMpKfSessionGetResult;
import weixin.mp.bean.kefu.result.WxMpKfSessionList;
import weixin.mp.bean.kefu.result.WxMpKfSessionWaitCaseList;
