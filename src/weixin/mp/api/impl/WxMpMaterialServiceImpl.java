...
import weixin.common.util.fs.FileUtils;
import weixin.common.util.http.MediaDownloadRequestExecutor;
import weixin.common.util.http.MediaUploadRequestExecutor;
import weixin.common.util.json.WxGsonBuilder;
import weixin.mp.api.WxMpMaterialService;
import weixin.mp.api.WxMpService;
import weixin.mp.bean.material.WxMpMaterial;
import weixin.mp.bean.material.WxMpMaterialArticleUpdate;
import weixin.mp.bean.material.WxMpMaterialNews;
import weixin.mp.bean.material.*;
import weixin.mp.util.http.*;
