...
import weixin.common.api.WxMessageDuplicateChecker;
import weixin.common.api.WxMessageInMemoryDuplicateChecker;
import weixin.common.session.InternalSession;
import weixin.common.session.InternalSessionManager;
import weixin.common.session.StandardSessionManager;
import weixin.common.session.WxSessionManager;
import weixin.common.util.LogExceptionHandler;
...
public class WxMpMessageRouter {
  ...
  /**
   * <pre>
   * 设置自定义的 {@link weixin.common.api.WxMessageDuplicateChecker}
   * 如果不调用该方法，默认使用 {@link weixin.common.api.WxMessageInMemoryDuplicateChecker}
   * </pre>
  ...
  /**
   * <pre>
   * 设置自定义的{@link weixin.common.session.WxSessionManager}
   * 如果不调用该方法，默认使用 {@link weixin.common.session.StandardSessionManager}
   * </pre>
  ...
  /**
   * <pre>
   * 设置自定义的{@link weixin.common.api.WxErrorExceptionHandler}
   * 如果不调用该方法，默认使用 {@link weixin.common.util.LogExceptionHandler}
   * </pre>
