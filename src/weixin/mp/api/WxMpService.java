...
public interface WxMpService {
   ...
   * </pre>
   *
   * @see #massGroupMessageSend(weixin.mp.bean.WxMpMassTagMessage)
   * @see #massOpenIdsMessageSend(weixin.mp.bean.WxMpMassOpenIdsMessage)
   */
   ...
   * <pre>
   * 分组群发消息
   * 如果发送图文消息，必须先使用 {@link #massNewsUpload(weixin.mp.bean.WxMpMassNews)} 获得media_id，然后再发送
   * 如果发送视频消息，必须先使用 {@link #massVideoUpload(weixin.mp.bean.WxMpMassVideo)} 获得media_id，然后再发送
   * 详情请见: http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1421140549&token=&lang=zh_CN
   * </pre>
   */
   ...
   * 可以参考，{@link weixin.common.util.http.MediaUploadRequestExecutor}的实现方法
   * </pre>
   */
