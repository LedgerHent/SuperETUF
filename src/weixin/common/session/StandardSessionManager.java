package weixin.common.session;

import weixin.common.util.res.StringManager;
  ...
  public void processExpires() {
    ...
    if (this.log.isDebugEnabled())
      //this.log.debug("Start expire sessions {} at {} sessioncount {}", getName(), timeNow, sessions.length);
        this.log.debug("End expire sessions "+getName()+" processingTime {} expired sessions: {}",  timeNow, sessions.length);
    ...
    if (this.log.isDebugEnabled())
        ...
        this.log.debug("End expire sessions "+getName()+" processingTime {} expired sessions: {}",  timeEnd - timeNow, expireHere);
